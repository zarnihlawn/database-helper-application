export const MongoDBSvg = (className: string = 'size-20') => `
<svg class="${className}" width="800px" height="800px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" fill="#000000">
